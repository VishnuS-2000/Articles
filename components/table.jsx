    ...
    const handleChange=async(e)=>{
        ...
        <ModalContent>
          ...
          <ModalBody className='font-poppins'>
            {multipleDelete.length} {authorsType?'Authors':'Articles'} selected will be permanently deleted
          </ModalBody>
          ...
          <ModalFooter className='font-poppins'>
            ...
            <Button colorScheme='red' variant="ghost" onClick={()=>{handleDeleteMany(); onClose()}}>Delete</Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
        ...
        <div className='flex flex-col  py-2 h-[120px] w-full border-b border-slate-300'>
                ...
                <input type='text' className='flex-[0.40] py-2 px-8 text-base font-[400] rounded-[30px] outline-none border border-slate-300  my-4 placeholder-secondary bg-[#FAFAFA] w-full' placeholder='Search writers,articles,topic' onChange={handleChange}/>
