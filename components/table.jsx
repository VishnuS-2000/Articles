...
export const DisplayTable=({data,count,page,navigationURL,limit,authorsType})=>{
    ...
    const handleDeleteMany=async()=>{
        ...
        <div className='flex flex-col  py-2 h-[120px] w-full border-b border-slate-300'>
                ...
                <input type='text' className='flex-[0.40] py-2 px-8 text-base font-[400] rounded-[30px] outline-none border border-slate-300  my-4 placeholder-secondary bg-[#FAFAFA] w-full' placeholder='Search writers,articles,topic'/>
