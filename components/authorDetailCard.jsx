...
export const AuthorDetail = ({author})=>{
    return (
        <div className="hidden desktop:flex bg-white flex-col absolute right-0 justify-start items-center space-y-5 pt-40 px-4 py-10 border-l border-[#E6E6E6]  h-full  max-w-[250px] font-poppins ">
        <div>
        ...
        <p className='text-[#757575] text-md font-[400]'>{author.bio}</p>
