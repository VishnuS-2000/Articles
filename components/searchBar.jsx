...
export const SearchBar  = () => {
    ...
    return(
        ...
        <div className="mobile:hidden desktop:flex   max-w-[25%] flex-[0.25]  right-0 top-0 flex-col text-base border-line border-l px-4 min-h-screen justify-start py-12">
